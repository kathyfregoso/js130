let Professional = {
  ...
  payTax() {
    console.log(`ugh taxes`);
  },
};

function delegate(callerObject, methodOwner, behavior, ...args) {
  return () => {
    return methodOwner[behavior].apply(callerObject, args);
  };
}
...
function extend(obj, mixin) {
  ...
  methodNames.forEach((name) => (obj[name] = delegate(obj, mixin, name)));

  return obj;
}

// shorter alternative to delegate and extend functions:
